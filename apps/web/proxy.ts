 ...
 *
 * Server Components cannot write cookies, so the refreshed token is written
 * here. Without this the session would expire mid-visit and every server render
 * would see a signed out user.
 */
